...
public class frmSuaNCC extends javax.swing.JFrame {
    ...
    /**
     * Creates new form frmSuaNCC
     */
    public frmSuaNCC() {
        initComponents();
        txtMaNCC.setText(frmNhanVienKho.maNCC);
        loadNCC(txtMaNCC.getText());
    }
    
    public void loadNCC(String maNCC){
        ArrayList<nhaCungCapPojo> dsNCC = new nhaCungCapDao().layDSNCC2(maNCC);
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/icons8-update-20.png"))); // NOI18N
        jLabel3.setText("Sửa");
    ...
    private void panelRound2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_panelRound2MouseClicked
        ...
        if(!kiemTraSDT(sdt)){
            ...
            if(!kiemTraEmail(email)){
                ...
                String sql = "update qldata.nhacungcap set tennhacungcap = '" + ten + "', sodienthoai = '" + sdt + "',email = '" + email + "',diachi = '" + diachi + "' where manhacungcap = '" + mancc + "'";
